...
var UpdateUserAvatarSerice = /** @class */ (function () {
    function UpdateUserAvatarSerice(usersRepository, storageProvider) {
        this.usersRepository = usersRepository;
        this.storageProvider = storageProvider;
    }
    UpdateUserAvatarSerice.prototype.execute = function (_a) {
    ...
    UpdateUserAvatarSerice = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject("UsersRepository")),
        __param(1, tsyringe_1.inject("StorageProvider")),
        __metadata("design:paramtypes", [Object, Object])
    ], UpdateUserAvatarSerice);
    return UpdateUserAvatarSerice;
}());
exports.default = UpdateUserAvatarSerice;
