                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (password && !old_password) {
                            throw new AppError_1.default("Old password was not informed");
                        }
                        if (!(password && old_password)) return [3 /*break*/, 4];
                    ...
                    case 5:
                        _b.password = _c.sent();
                        _c.label = 6;
                    case 6: return [2 /*return*/, this.usersRepository.save(user)];
                }
            });
        });
    };
