...
describe("ResetPasswordService", function () {
    ...
    it("should be able to reset the password with expired token", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
                ...
                case 2:
                    token = (_a.sent()).token;
                    // Customize the return of Date.now, with your own implementation
